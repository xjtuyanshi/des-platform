...
import {
  ...
  pauseGenericRuntime,
  registerGenericInlineStudy,
  renderGenericWorkbench,
...
app.get('/api/des-workbench', (_request: Request, response: Response) => {
  response.type('html').send(renderGenericWorkbench());
});
